...
urlpatterns = [
    ...
    path('logout', index_view.logout, name='logout'),
    path('index', index_view.index, name='index'),
    path('index/accounts', nonboomer_view.accounts, name='accounts'),
    path('index/accounts/confirm', nonboomer_view.editZoomerConfirm, name='editZoomerConfirm'),
    path('index2/', index_view.boomerIndex, name='index2'),
    path('index2/accounts', boomer_view.accounts, name='baccounts'),
    path('index2/accounts/confirm', boomer_view.editBoomerConfirm, name='editBoomerConfirm'),
    ...
    path('signupBoomerConfirm', index_view.signupBoomerConfirm, name='signupBoomerConfirm'),
